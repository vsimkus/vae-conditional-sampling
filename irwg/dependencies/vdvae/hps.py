...
cifar10.num_mixtures = 10
cifar10.image_size = 32
cifar10.image_channels = 3
cifar10.warmup_iters = 100
cifar10.dataset = 'cifar10'
cifar10.restore_path = 'models/vdvae/cifar10-seed0-iter-900000-model-ema.th'
cifar10.no_bias_above = 64
cifar10.n_batch = 16
cifar10.ema_rate = 0.9999
cifar10.bottleneck_multiple = 0.25
...
i64.restore_path = 'models/vdvae/imagenet64-iter-1600000-model-ema.th'
...
ffhq_256.restore_path = 'models/vdvae/ffhq256-iter-1700000-model-ema.th'
ffhq_256.num_mixtures = 10
...
ffhq_256.image_size = 256
ffhq_256.image_channels = 3
ffhq_256.no_bias_above = 64
ffhq_256.grad_clip = 130.
ffhq_256.skip_threshold = 180.
ffhq_256.bottleneck_multiple = 0.25
...
ffhq1024.restore_path = 'models/vdvae/ffhq1024-iter-1700000-model-ema.th'
...
#     parser.add_argument('--sample_vae', action="store_true")
